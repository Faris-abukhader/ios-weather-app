...
class getData:ObservableObject {
    ...
    func getDataFor(lon:Double,lad:Double) {
        ...
        let urlString =
        "https://api.openweathermap.org/data/2.5/onecall?lat=\(lad)&lon=\(lon)&exclude=minutely&units=metric&appid=cad2cdd0b81bdfc9b1739a3fac44dc01"
    ...
    func isDay()->Bool{
        let dt = Int(self.Data?[0].current.dt ?? 0) ,
